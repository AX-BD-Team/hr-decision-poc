...
### S1: 조직 인력 OPEX 유지/조정 (기본)
- **핵심 질문**: "현재 인력 구성으로 Q2 프로젝트 수행이 가능한가?"
- Path A: Maintain (현 구조 유지) — Score 76, 비용 0~30M, 즉시~2주
- Path B: Adjust (부분 조정) — Score 82, 비용 30~80M, 2~6주
- Path C: Restructure (구조 변경) — Score 67, 비용 80~180M, 6~12주

### S2: 조직 인력 OPEX 절감(안)
- **핵심 질문**: "OPEX 10% 감축 조건에서 핵심 프로젝트 수행이 가능한가?"
- OPEX 절감 목표 엔티티/엣지 추가
- 비용 제약 하 대안 메트릭 조정

### S3: 핵심 인력 병목 완화
- **핵심 질문**: "병목 인력을 완화하면서 일정 리스크를 최소화할 수 있는가?"
- 병목 인력(김A) 강조 + 후보 인력(정E) 추가
- SPOF 리스크 강화
